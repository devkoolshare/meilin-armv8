...
unix_domain_path_ctrl="/tmp/xunyou_ctrl_log"
unix_domain_path_proxy="/tmp/xunyou_proxy_log"
unix_domain_path_dev="/tmp/xunyou_dev_log"
unix_domain_path_ipset="/tmp/xunyou_ipset_log"
...
set_log_level()
{
    ...
    ${XunyouPath}/bin/udp-post -u ${unix_domain_path_ctrl} -v ${log_level_num}
    ${XunyouPath}/bin/udp-post -u ${unix_domain_path_proxy} -v ${log_level_num}
    ${XunyouPath}/bin/udp-post -u ${unix_domain_path_dev} -v ${log_level_num}
    [ ${ipset_enable} == "1" ] && ${XunyouPath}/bin/udp-post -u ${unix_domain_path_dev} -v ${log_level_num}
}
